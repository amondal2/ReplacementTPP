...
main_out <- "/RAID0/ReplacementTPP_Recoded/Kenya/highEIR"
# CONSTANTS
CUT_M <- 1.0
CUT_F <- 1.0
FMC = 0.50
...
# SWEEP PARAMETERS
PARS_B <- c(1,1,0,0,0)
PARS_E <-  as.matrix(read.csv("recoded_params.csv"))

# Make fitness costs in terms of fitnesses
PARS_E[, "sB"] = 1-PARS_E[, "sB"]/2
PARS_E[, "sH"] = 1-PARS_E[, "sH"]/2
